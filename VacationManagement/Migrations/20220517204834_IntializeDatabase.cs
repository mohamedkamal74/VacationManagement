        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReaquestVacationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacationPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VacationPlans_RequestVacations_ReaquestVacationId",
                        column: x => x.ReaquestVacationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VacationPlans_ReaquestVacationId",
                table: "VacationPlans",
                column: "ReaquestVacationId");
        }
